...
if (!license.includes('Copyright (c) 2026 ThinkHome contributors')) throw new Error('ThinkHome MIT license missing');
if (!upstream.includes('Copyright (c) 2026 Julius Brussee')) throw new Error('upstream MIT attribution missing');
